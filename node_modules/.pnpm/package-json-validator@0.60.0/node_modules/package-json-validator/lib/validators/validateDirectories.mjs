...
const validateDirectories = (obj) => {
	...
	if (obj && typeof obj === "object" && !Array.isArray(obj)) {
		...
		for (let i = 0; i < entries.length; i++) {
			...
			else if (value.trim() === "") childResult.addIssue(`the value of property ${propertyName} is empty, but should be a path to a directory`);
			if (key.trim() === "") childResult.addIssue(`property ${propertyName} has an empty key, but should be a path to a directory`);
